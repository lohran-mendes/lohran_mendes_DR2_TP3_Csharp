namespace lohran_mendes_DR3_TP3;
...
public class Ingresso
{
    ...
    {
        return $"O ingresso para {NomeDoShow} está custando R${Preco} e ainda temos {QuantidadeDisponivel} disponíveis.";
    }
    ...
    public static void Exercicio_5()
    {
        ...
        Console.WriteLine($"Quantidade disponível de ingressos do show através do getter: {ingresso.QuantidadeDisponivel}");
    }
}
